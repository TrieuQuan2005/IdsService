...
class HostBinaryFeatures:
    ...
    def feature_names() -> List[str]:
        return list(HostBinaryFeatures.FEATURE_NAMES)
...
class FlowBinaryFeatures:
    ...
    @staticmethod
    def feature_names() -> List[str]:
        return list(FlowBinaryFeatures.FEATURE_NAMES)
...
class HostMultiFeatures:
    ...
    @staticmethod
    def feature_names() -> List[str]:
        return list(HostMultiFeatures.FEATURE_NAMES)
...
class FlowMultiFeatures:
    ...
    @staticmethod
    def feature_names() -> List[str]:
        return list(FlowMultiFeatures.FEATURE_NAMES)
